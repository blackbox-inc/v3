                ...
                <div class="card">
                    <div class="card-header ">
                        ...
                        <button class="btn btn-secondary btn-sm float-right" data-toggle="collapse"
                            ...
                            aria-controls="collapseExample">X</button>
                    </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control updatebarcode"
                                                        value="{{ $bucs[0]->barcode }}" readonly>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control updateName"
                                                                value="{{ $bucs[0]->fullname }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label for="fullname">PASSPORT</label>
                                                            <input type="text" class="form-control updatePassport"
                                                                value="{{ $bucs[0]->passport_no }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        @if (Auth::user()->type == 0)
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control aofficer">
                                                                    <option selected
                                                                        value="{{ $bucs[0]->account_officer }}">
                                                                        {{ $bucs[0]->account_officer }}</option>
                                                        ...
                                                        @else
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control aofficer"
                                                                    value="{{ $bucs[0]->account_officer }}" readonly>
                                                            </div>
                                                        @endif
                                                    </div>
                                                    <div class="col-lg-6">
                                                        ...
                                                        @else
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control allowoff "
                                                                    value="{{ $bucs[0]->allowed }}" readonly>
                                                            </div>
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <div class="input-group-prepend" id="button-addon3">
                                                            <button class="btn btn-outline-secondary skilledUpdate"
                                                                type="button">SKILLED</button>
                                                            <button class="btn btn-outline-secondary dhUpdate"
                                                                type="button">DH</button>
                                                        </div>
                                                        @if ($bucs[0]->category == 0)
                                                            <input type="text" class="form-control categoryUpdate"
                                                                value="DH" readonly>
                                                        @else
                                                            <input type="text" class="form-control categoryUpdate"
                                                                value="SKILLED" readonly>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <small style="text-align: center ">DATE MEMBER:
                                            {{ $bucs[0]->created_at }}</small>
                                        <br>
                                        <br>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <img class="card-img-top"
                                            src="{{ asset('uploaded_photo') . '/' . $basic_info[0]->photo }}"
                                            id="image-preview" alt="Card image cap">
                                        <img class="card-img-top"
                                            src="https://eomsinc.com/v2/resume_builder/upload/{{ $basic_info[0]->photo }}"
                                            id="image-preview" alt="Card image cap">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="" id="basic_infos_barcode"
                                        class="form-control" value="{{ $basic_info[0]->barcode }}" readonly>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" id="basic_infos_dob" class="form-control"
                                        value="{{ $basic_info[0]->dob }}">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="">PLACE OF BIRTH</label>
                                    <input type="text" name="" id="basic_infos_pob" class="form-control"
                                        value="{{ $basic_info[0]->pob }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="" id="basic_infos_height"
                                        class="form-control" value="{{ $basic_info[0]->height }}">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label for="">WEIGHT</label>
                                    <input type="text" name="" id="basic_infos_weight"
                                        class="form-control" value="{{ $basic_info[0]->weight }}">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="basic_infos_blood_type">
                                        <option selected value="{{ $basic_info[0]->blood_type }}">
                                            {{ $basic_info[0]->blood_type }}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="basic_infos_marital_status">
                                        <option selected value="{{ $basic_info[0]->marital_status }}">
                                            {{ $basic_info[0]->marital_status }}</option>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="basic_infos_no_of_children" class="form-control"
                                        value="{{ $basic_info[0]->no_of_children }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
            ...
            <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                ...
                <div class="card">
                    <div class="card-header bgcolor">
                        <button class="btn btn-warning btn-sm float-right" data-toggle="modal"
                            data-target=".contact_modal">ADD CONTACT</button>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table table-sm">
                            ...
                            <tbody> <?php $count = 1; ?> @foreach ($c_contact as $contact)
                                    <tr>
                                        ...
                                        <td>
                                          <button class="btn btn-danger delete_contact"
                                              data-id="{{ $contact->id }}">
                ...
                <div class="card">
                    <div class="card-header bgcolor">
                        <button class="btn btn-warning btn-sm float-right" data-toggle="modal"
                            data-target="#contactPerson">ADD CONTACT</button>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table table-sm" style="font-size: 0.8em">
                            ...
                            <tbody> <?php $counter = 1; ?> @foreach ($contactPerson as $cperson)
                                    <tr>
                                        ...
                                        <td>{{ $cperson->email }}</td>
                                        <td>
                                            <button class="btn btn-danger delete_cperson"
                                                data-id="{{ $cperson->id }}">
                                                <i class="fas fa-trash"></i> | DELETE </button>
                                        </td>
                                    </tr>
                                ...
                                <form action="/contact-person" method="POST"> @csrf <br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control " name="contact_name"
                                            id="contact_name" aria-describedby="helpId" placeholder="" required>
                                    </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control " name="relationship"
                                                    id="relationship" aria-describedby="helpId" placeholder=""
                                                    required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control " name="contact_number"
                                                    id="contact_number" aria-describedby="helpId" placeholder=""
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                          <div class="form-group">
                                            ...
                                            <input type="text" class="form-control " name="contract_address"
                                                id="contract_address" aria-describedby="helpId" placeholder="" required>
                                        </div>
                                        </div>
                                        <div class="col-lg-6">
                                          <div class="form-group">
