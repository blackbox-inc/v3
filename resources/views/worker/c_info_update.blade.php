...
@endphp
@if (count($basic_info) === 0) {{ header('Refresh:0') }} @endif 
<style>
                           ...
                           <div class="card-body">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="input-group mb-3">
                                    ...
                                    @if ($bucs[0]->category == 0) <input type="text" class="form-control categoryUpdate" value="DH" readonly> @else <input type="text" class="form-control categoryUpdate" value="SKILLED" readonly> @endif
                                 </div>
                              </div>
                           </div>
                        </div>
      ...
      <div class="card">
         ...
         <div class="card-body">
            ...
            <table class="table table-sm">
               ...
               <tbody>
                  <?php $count = 1; ?> @foreach ($c_contact as $contact) 
                  <tr>
      ...
      <div class="card">
         ...
         <div class="card-body">
            ...
            <table class="table table-sm" style="font-size: 0.8em">
               ...
               <tbody>
                  <?php $counter = 1; ?> @foreach ($contactPerson as $cperson) 
                  <tr>
         ...
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <form action="/contact" method="POST">
                  @csrf <input type="hidden" name="barcode" value="{{ $bucs[0]->barcode }}">
                  <div class="modal-body">
                     <div class="input-group mb-3">
                        <div class="input-group-prepend">
      ...
      <div class="card">
         ...
         <div class="card-body">
            <div class="card">
               ...
               <div class="card-body">
                  <div id="accordion">
                     @if(count($c_exp)) @foreach($c_exp as $exp) 
                     <div class="card">
                        ...
                        <div class="card border-0 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                           ...
                           <div id="collapse-{{$category->id}}" class="collapse" aria-labelledby="heading-{{$category->id}}" data-parent="#accordion">
                              <div class="card-body accordion-body">
                                 ...
                                 <iframe id="fred" style="border:1px solid #666CCC" title="PDF in an i-Frame" src="{{asset('uploaded_file') .'/'.$category->filename}}#zoom=50%" frameborder="1" scrolling="auto" height="400" width="100%"></iframe>
                              </div>
                           </div>
                        </div>
                        @endforeach 
